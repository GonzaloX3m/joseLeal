...
public class ModVenderVivienda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblViviendasVenta.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblViviendasVentaMouseClicked(evt);
            }
        });
    ...
    private void tblViviendasVentaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblViviendasVentaMouseClicked
        // TODO add your handling code here:
        
    }//GEN-LAST:event_tblViviendasVentaMouseClicked
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        if(viviendas!=null && !viviendas.isEmpty())
        {
            ...
            if(row>=0)
            {
                ...
                venta.setCliente(c);
                venta.setUsuario(u);
                venta.setFecha(dateFormat.format(now));
            }
