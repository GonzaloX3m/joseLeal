...
public class ModCrearCliente extends javax.swing.JFrame {
    ...
    public ModCrearCliente(Usuario u) {
        try {
            ...
            Logger.getLogger(ModCrearCliente.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        btnRegistrarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Registrados.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(40, 40, 40)
                .addComponent(btnRegistrarCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnRegistrarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarClienteActionPerformed
        try {
            ...
            c.setRun(txtRunCliente.getText());
            c.setNombre(txtNombreCliente.getText());
            c.setSueldo(Integer.parseInt(txtSueldoCliente.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModCrearCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
